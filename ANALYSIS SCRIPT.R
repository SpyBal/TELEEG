...
## Example on how to produce ome topoplot (in order to keep the script compact)
## For creating the remaining plots you need to  change the **datatopo1** to
...
#### Plot the network comparison tests


## Plot the results on the structure comparison
...
## Plot the results on the connectivity comparison
